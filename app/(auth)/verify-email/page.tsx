  ...
  return (
    <ScreenContainer>
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        {resent && (
          <div
            className="rounded-2xl px-4 py-3 mb-4 text-sm font-medium w-full"
            style={{ background: "rgba(52,199,89,0.12)", color: "var(--color-green)" }}
          >
        ...
        {error && (
          <p className="text-sm mb-4 font-medium" style={{ color: "var(--color-red)" }}>{error}</p>
        )}
